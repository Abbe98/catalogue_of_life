...
ActiveRecord::Schema.define(version: 20151231111159) do
  ...
  create_table "names", force: :cascade do |t|
    ...
    t.string   "nameable_subtype", limit: 255
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end

  add_index "names", ["nameable_id", "nameable_type", "nameable_subtype", "language_iso"], name: "unique_names_per_type_languages", unique: true, using: :btree
